...
from . import views
from .views import IndexView, CertificadosView, gerar_certificado, AdministradoresView, PresencasView, AulasView, AlunosView, registrar_aluno, registrar_presenca, Sucesso_registroView, registrar_aula, SobreView
urlpatterns = [
